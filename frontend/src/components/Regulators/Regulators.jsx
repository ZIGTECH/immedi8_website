				...
				<div className="container mx-auto flex">
					...
					<div className="regulators">
						...
						<ul className="list-disc">
							<li className="">
								Authorize By the Financial Services Authority,
								under the Payment Services Regulation 2009. PSD
								584027 for the Provision of Payment Services.
							</li>

							<li className="mt-3">
								Registered with Her Majesty’s Revenue and
								Customs (HMRC) for AML and Terrorism Financing
								Regulation. Registration Number 12585462
							</li>
