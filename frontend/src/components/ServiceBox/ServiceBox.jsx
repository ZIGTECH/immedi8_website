	...
	return (
		<>
			<div
				style={style}
				// key={i}
				className="group shadow-2xl w-full h-[530px] md:h-[550px] p-10 mt-8 md:mt-14 md:-mb-12 transition duration-500 ease-in-out transform sm:hover:scale-105 hover:z-50 hover:border hover:border-blue-800 rounded-sm cursor-pointer ">
				<div
					style={style}
				...
				<p className="group-hover:text-red-700 text-center md:text-start text-2xl font-extrabold mb-5 font-sans">
					{title}
				</p>
