			...
			<div className="container mx-auto" id="contact">
				<div className="lg:grid lg:grid-cols-2 lg:gap-10 mt-10 border-t-2">
					...
					<div className="w-full text-white bg-red-700 p-10 md:p-10 ">
						<div className="lg:mt-40 mx-auto lg:w-3/4 md:pb-20">
							...
							<div className="md:grid md:grid-cols-2 md:gap-10 lg:border-l-2">
								...
								<div className="group flex justify-center mt-5 md:mt-14 lg:mt-9  cursor-pointer">
									<span className="">
							...
							<div className="md:grid md:grid-cols-2 lg:border-l-2">
						...
						{/* SOCIAL MEDIA ICONS */}
						<div class="hidden md:flex md:mt-5  space-x-3 sm:justify-center items-center sm:mt-0">
							<a
								data-aos="zoom-in-down"
								data-aos-duration="3000"
								href="#"
